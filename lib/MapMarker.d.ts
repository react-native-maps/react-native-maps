...
export declare type MapMarkerProps = ViewProps & {
    /**
...
declare type OmittedProps = Omit<MapMarkerProps, 'stopPropagation'>;
export declare type NativeProps = Modify<OmittedProps, {
    icon?: string;
