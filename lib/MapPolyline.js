...
const MapPolylineNativeComponent_1 = require("./MapPolylineNativeComponent");
class MapPolyline extends React.Component {
    ...
    startPolylineAnimation(staticColor, animationDuration, delay) {
        if (this.polyline.current) {
            MapPolylineNativeComponent_1.Commands.startPolylineAnimation(this.polyline.current, staticColor, animationDuration, delay);
        }
    }
    stopPolylineAnimation() {
        if (this.polyline.current) {
            MapPolylineNativeComponent_1.Commands.stopPolylineAnimation(this.polyline.current);
        }
    }
    render() {
