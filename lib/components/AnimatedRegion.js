...
export default class AnimatedMapRegion extends AnimatedWithChildren {
  constructor(valueIn = {}) {
    super();
    this.useNativeDriver = !!valueIn.useNativeDriver;
    this.latitude = this.setInitialValue(
      valueIn.latitude,
      defaultValues.latitude
    );
    this.longitude = this.setInitialValue(
      valueIn.longitude,
      defaultValues.longitude
    );
    this.latitudeDelta = this.setInitialValue(
      valueIn.latitudeDelta,
      defaultValues.latitudeDelta
    );
    this.longitudeDelta = this.setInitialValue(
