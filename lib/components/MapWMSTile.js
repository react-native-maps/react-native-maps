...
const propTypes = {
  ...
  /**
   * EPSG spec for url Template boundbox calulation
   * https://epsg.io/
   * */
  epsgSpec: PropTypes.oneOfType([PropTypes.String, PropTypes.oneOf(["EPSG:900913", "EPSG:4326"])]),
};
