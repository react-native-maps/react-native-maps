...
const propTypes = {
  ...
  /**
   * The url template of the tile server. The patterns {minX} {maxX} {minY} {maxY} {width} {height} will be replaced at
   * runtime according to EPSG:900913 specification bounding box.
