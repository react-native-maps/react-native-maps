...
const AIRMapGradientPolyline = requireNativeComponent("AIRMapGradientPolyline");
...
class MapPolyline extends React.Component {
  ...
  render() {
    const AIRMapPolyline = Platform.OS == "android" && this.props.strokeColors !== undefined
      ? AIRMapGradientPolyline
      : this.getAirComponent();
    return (
