...
class MapView extends React.Component {
    ...
    setMarkerPoints(locations, imageDrawableName = 'marker', skipClear = false) {
        if (this.map.current) {
            MapViewNativeComponent_1.Commands.setMarkerPoints(this.map.current, locations, imageDrawableName, skipClear);
        }
    }
