...
export default React.forwardRef(
  ({ children, zoom = DEFAULT_ZOOM, initialRegion = DEFAULT_CENTER, ...props }, ref) => {
    const center = convertCoordinate(initialRegion);
    console.log('Map: ', props, center);

    return (
      <LeafletMap {...props} url="https://unpkg.com/leaflet@1.5.1/dist/leaflet.css" zoom={zoom} center={center} ref={ref}>
        <TileLayer
