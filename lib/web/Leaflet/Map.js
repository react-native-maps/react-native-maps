...
import { featureGroup as FeatureGroup, point as createPoint, latLngBounds as boundsForCooords } from 'leaflet';
...
export default class extends React.Component {
  ...
  fitToSuppliedMarkers = (markers, edgePadding, animated) => {
    return this.fitToCoordinates(markers.map(({ coordinate }) => coordinate), edgePadding, animated);
  }
