...
| `classicalGoogleMarkers`          | boolean                              | `true`       | If 'false' map will use new [AdvancedMapMarkers](https://developers.google.com/maps/documentation/android-sdk/advanced-markers/start) instead of old one's <br /> **Note**: Android Google Maps only.                                                                                                                                                                                                                                                                                                                            |
