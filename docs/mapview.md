...
| `googleMapId`                     | string                               |              | A map ID is a unique identifier that represents a single instance of a Google Map. For more informations check [Google create a map ID documentation](https://developers.google.com/maps/documentation/get-map-id#create-a-map-id) <br /> **Note**: Android Google Maps only.                                                                                                                                                                                                                                                    |
