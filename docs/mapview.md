...
| `onMyLocationButtonClick` |                                                                          | Callback that is called when user clicks on "My Location" button. **NOTE:** Google Maps only. Make sure **showsUserLocation** is set to _true_                                                                                                                                                                                        |
