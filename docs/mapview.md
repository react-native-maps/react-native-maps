...
| `preventDefaultMarkerSelection`   | `Boolean`                            | `false`      | If `true` the map will not perform its default selection behavior when a marker is tapped, allowing the caller to handle the event instead. **Note**: Google Maps only.                                                                                                                                                                                                                                                                                                                                                          |
