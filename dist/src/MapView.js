...
class MapView extends React.Component {
    ...
    render() {
        ...
        const { onCalloutPress, onIndoorBuildingFocused, onKmlReady, onLongPress, onMarkerDeselect, onMarkerPress, onMarkerSelect, onRegionChangeStart, onRegionChange, onRegionChangeComplete, onPress, onMapReady, minZoomLevel, maxZoomLevel, region, provider, children, customMapStyle, ...restProps } = this.props;
